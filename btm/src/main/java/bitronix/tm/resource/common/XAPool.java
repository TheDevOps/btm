...
public class XAPool implements StateChangeListener {
    ...
    public synchronized int totalPoolSize() {
        return objects.size();
    }
    ...
    private static boolean containsXAResourceHolderMatchingGtrid(XAStatefulHolder xaStatefulHolder, final Uid currentTxGtrid) {
        List<XAResourceHolder> xaResourceHolders = xaStatefulHolder.getXAResourceHolders();
